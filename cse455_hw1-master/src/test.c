...
void test_bl_resize()
{
    ...
    save_image(resized2, "output/bl_output2");
    TEST(same_image(resized2, gt2));
    free_image(im2);
    free_image(resized2);
    free_image(gt2);
...
void test_gaussian_filter(){
    ...
    save_image(f, "output/gaussian_dog");
    free_image(f);
    free_image(gt);
}
...
void test_hybrid_image(){
    ...
    save_image(lfreq_man, "output/lowman");
    save_image(lfreq_w, "output/lowwoman");
    save_image(hfreq_w, "output/highwomen");
...
void test_sobel(){
    ...
    image blur = convolve_image(imo, f, 1);
    clamp_image(blur);
    save_png(blur,"output/sobel.jpg");
...
void test_bilateral_filter(){
    ...
    image ans = load_image("figs/bilateral_post.png");

    // 2.7
    image output = bilateral_filter(im);

    save_image(output, "output/123.jpg");
    free_image(im);
    free_image(ans);
}
